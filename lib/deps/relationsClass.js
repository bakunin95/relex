...
=======
			    			fs.readFile(filePath,"utf-8", function read(err, data) {
								db.addNodesAsync({"name":filePath,"group":group, "exist":true, "data":data},cbEtape1);    											    		
			    			});
>>>>>>> 1b6cd69c802ab730b60e42bde85f3d585a6c92f1
			    		}
			    		else{
...
//or : [{	group : 'js'}, {group : 'js-markup'	}]
			     ...
			     function(cbMiscClass){
			    	db.findNodes({},function(nodesList){
			    		miscClass.analyze(nodesList,function(){
			    			console.log("finished misc");
			    			cbMiscClass();
			    		});
			    	});
			    },
