...
var jsClass = module.exports = {
		            ...
		            if(_.isMatch(node,query)){
         				try{
			            	...
			            	console.log("#############");*/
		        				...
		        				jsClass.cnode[genNode.nodeId] = [node,parser];
	...
	recursiveNode: function(root,parent,cbRecursive){
	    ...
	    async.eachSeries(root.node,function(currentNode,cb){
	    	...
	    	//var node
	    	//var parent
	    	//console.log("currNode",jsClass.cnode[currentNode.id]);


	    	var node = jsClass.generateNode(jsClass.cnode[currentNode.id][0],parent,jsClass.cnode[currentNode.id][1]);
